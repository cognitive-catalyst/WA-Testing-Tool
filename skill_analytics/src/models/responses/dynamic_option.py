...
@dataclass
class DynamicOptionResponse(Response):
    ...
    def __post_init__(self):
        self.response_type = ResponseType.DYNAMIC_OPTION
    
    def __str__(self) -> str:
        return f"<Dynamic Options>"

    @classmethod
    def from_dict(cls, data: dict) -> 'DynamicOptionResponse':
        return cls(
