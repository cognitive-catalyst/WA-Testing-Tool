...
class FallbackResolver(Resolver):
    """Resolver that triggers fallback behavior."""
    
    def __post_init__(self):
        """Set the resolver type after dataclass initialization."""
        self.resolver_type = ResolverType.FALLBACK
    
    @classmethod
    def from_dict(cls, data: dict) -> 'FallbackResolver':
        """Create a FallbackResolver instance from a dictionary."""
        return cls()
